/*
Based on C++ code located at https://en.wikipedia.org/wiki/Dining_philosophers_problem,
ported to rust. Binary semaphores used in the C++ version replaced with mutex/condition
variables, see for example https://zhu45.org/posts/2019/Oct/20/semaphore/
*/

/*
 * (C) Copyright Syd Logan 2024
 *
